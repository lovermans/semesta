...
var RESOURCES = {
    assets: [
        ...
        "{{ Vite::asset('resources/images/svg/internal-icon-sprites.svg') }}",
        "{{ Vite::asset('resources/images/svg/external-icon-sprites.svg') }}",
        "{{ Vite::asset('resources/images/app-icon/app-icon-sprites.svg') }}",
